...
const FAT2025Summary = ({ onNext }) => {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 pb-10 font-sans flex flex-col">
      <div className="flex-grow">
        ...
        <div className="px-4 space-y-4">
          ...
          {/* Footer Text */}
          <div className="text-center pt-6 pb-6 opacity-80">
